<div>
    <x-card class="mx-auto">
        ...
        @if ($post->type == 'advert')
            ...
            <div style="display: none;" class="overflow-auto mycard-primary mb-5 block max-w-96" x-data="{ visible: @entangle('isCartAddItemVisible') }" x-show="visible"
                ...
                x-transition:leave-end="opacity-0 translate-y-5 h-0"
