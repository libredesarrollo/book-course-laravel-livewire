...
<div>
    ...
    <flux:button class="ml-1 mb-3" variant='primary' icon="plus" href="{{ route('volt-d-category-create') }}">
        {{ __('Create') }}
    </flux:button>
            ...
            <tbody>
                @foreach ($categories as $c)
                    <tr
                        ...
                        <td>
                            <a href="{{ route('volt-d-category-edit', $c) }}">Edit</a>

                            <flux:modal.trigger wire:click="selectCategodyToDelete({{ $c }})"
