        ...
        <div class="w-full sm:max-w-4xl overflow-hidden">
            @foreach ($posts as $p)
                ...
                <div class="flex flex-col items-center mt-7">
                    {{-- <a class="btn-primary" href="{{ route('volt.web.show', $p->slug) }}">Show!</a> --}}
                    <flux:button variant='primary' class="flux-button-web" href="{{ route('volt.web.show', $p->slug) }}"> {{ __('Show') }} </flux:button>
